...
void Function_Overload_test(void)
{
	...
	Add(5.1f, 2.3f);						//  Add(float x, float y)
	//Add(5.1, 2);                            // compiler error call of overloaded ‘Add(double, int)’ is 	
	...
	// if we make the double function is float , call of overloaded ‘Add(double, double)’ is ambiguous error will appear 
	...
	*/
	...
	The extern "C" declaration in C++ is used to specify that a function or block of code 
	should be treated as C language code, rather than C++ code. It is typically used when interacting 
	with C code or when you need to ensure C linkage for a specific function. Here are a few examples of 
	how extern "C" can be used in C++:
	
	
	The extern "C" declaration in C++ is used to specify that a function or 
	block of code should be treated as C language code, rather than C++ code. 
	It is typically used when interacting with C code or when you need to ensure 
	C linkage for a specific function. Here are a few examples of how extern "C" can be used in C++:
	*/
	...
	// extern "C" allow you to use C languages with C ++ without linking error
