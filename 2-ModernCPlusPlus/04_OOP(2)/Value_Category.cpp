...
int main(void)
{
	...
	*/
	...
	int t = 10;
	print(t);				// print(int x)  t is r-value
	...
	int p1=10 --> the compiler will create a temp variable and assigne 10 to it then copy the value to p1 ==>  
	int &&p2 = 10 --> more optimization , compiler create a temp variable and then make p2 point to it 
    note that 
    this not occur in primitive data types like int , float ,...... , but to make it clear we say this example
    this occur when we use any class or vector , string ,........
	
	*/
		
	//int&& r4 = tmp; // we see above that this exepression give an error
	int l = 20;
	const int l2 = 40;
	int&& r4 = std::move(l);	// by using the move semantics , tis convert the l-value to r-value
